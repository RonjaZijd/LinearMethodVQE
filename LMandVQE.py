"""
Last edited: 17/08/21
by: Ronja Johanna Zijderveld

Linear Method in a variational quantum eigensolver. Main program.
"""
...
#information into tables so also possible to easily load into panda dataframes
...
labels = ["Linear Method Eig", "BFGS", "Gradient Descent", "ADAM"]

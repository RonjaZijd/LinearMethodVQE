...
#Hamiltonian
H_VQE_coeffs = HML.H_H4_coeffs
H_VQE_gates = HML.H_H4_gates
print(H_VQE_coeffs)
print(H_VQE_gates)
...
lm_scaling = lambda n : n*2*execs_per_H #lambda function to calculate how many times circ is done to get H and S

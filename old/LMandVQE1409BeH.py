...
U_gates = np.array([['RY', 'RZ'], ['RY', 'RZ'], ['RY', 'RZ'],['RY', 'RZ'],['RY', 'RZ'],['RY', 'RZ']]) ##the U gates in order
entangle_gates = np.array([[0,1], [1,2], [2,3], [3,4], [4,5]]) ###the entangled gates at the end
...
def circuit(params, wires):
   ...
   qml.BasisState(np.array([0,0,0,0,0,0], requires_grad=False), wires=wires)
   for i in wires:
